 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'SENA');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Alejandro Zuluaga López');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Reporte de estados');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Alejandro Zuluaga López - Aprendiz SENA");
